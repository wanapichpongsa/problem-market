...
use tracing::info;
  ...
  pub struct PullRequestPayload {
    pub action: String, // closed/open
    pub pull_request: PullRequest, // defined in successor struct
  }
  #[derive(Deserialize, Debug)]
  pub struct PullRequest {
    pub merged: bool,
    pub user: User,
    pub merged_at: Option<String>, // 2024-10-13T01:57:59Z
  }
  ...
  // keep as wallet address for now, not user_id as we haven't set up relational database
